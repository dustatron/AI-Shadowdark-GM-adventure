...
**Trade dress** by Brandish Gilhelm. Lucas Korte, Matt Ray, Jessee Egan, Yuri Perkowski Domingos, Brandish Gilhelm, Indra Maulana Akbar, Abdul Latif, Chris Yarbrough, Bradley K McDevitt, Del Teigeler. Some artwork © 2015 Dean Spencer, used with permission. All rights reserved. Some artwork © 2023 William McAusland, used with permission.

#### **Fonts**

JSL Blackletter font © 2023 Jeffrey S. Lee. Old Newspaper font © 2023 Martin Steiner. Fullteron font © 2023 Emyself Design. Montserrat font family © 2023 Julieta Ulanovsky, Sol Matas, Juan Pablo del Peral, Jacques Le Bailly.

#### **Legal Information and Attribution Statement**

Printed in China by Boda Games. Not for resale or redistribution. Permission granted to copy for personal use only. Shadowdark © 2023 The Arcane Library, LLC. The Arcane Library® and Shadowdark™ are trademarks of The Arcane Library, LLC. This work includes material taken from the System Reference Document 5.1 ("SRD 5.1") by Wizards of the Coast LLC and available at https://dnd.wizards.com/resources/systemsreference-document. The SRD 5.1 is licensed under the Creative Commons Attribution 4.0 International License available at https://creativecommons. org/licenses/by/4.0/legalcode.

{5}------------------------------------------------

# Contents

| Shadowdark        | 7  | Gameplay             |    |
|-------------------|----|----------------------|----|
| The Basics        | 8  | Rolling the Dice     | 40 |
| Characters        | 11 | Luck Tokens          | 41 |
| Overview          | 12 | Stats                | 42 |
| Background        | 14 | Making Checks        | 43 |
| Stats             | 15 | Time                 | 44 |
| Ancestry          | 16 | Turn Order           | 45 |
| Fighter Class     | 18 | Crawling             | 46 |
| Priest Class      | 20 | Resting              | 48 |
| Thief Class       | 22 | Stealth and Surprise | 49 |
| Wizard Class      | 24 | Combat               | 50 |
| Titles            | 26 | Casting Spells       | 52 |
| Alignment         | 28 | Wizard Mishaps       | 54 |
| Languages         | 29 | Scrolls and Wands    | 55 |
| Deities           | 30 | Spell Attributes     | 56 |
| Gear              | 32 | Spell Lists          | 57 |
| Character Names   | 36 | Spells               | 58 |
| Level Advancement | 37 |                      |    |

{6}------------------------------------------------

# <span id="page-6-0"></span>Shadowdark
...
<span id="page-7-0"></span>If this is your first time playing *Shadowdark RPG*, it's helpful to start with a premade character. Several adventurers are included with this book.

These **quickstart rules** cover beginner characters for their first few adventures. The full rules go much further; check them out at [thearcanelibrary.](https://www.thearcanelibrary.com/pages/shadowdark) [com/pages/shadowdark.](https://www.thearcanelibrary.com/pages/shadowdark)
...
# <span id="page-10-0"></span>Characters
...
<span id="page-11-0"></span>To make a *Shadowdark RPG* character (also called a player character, or **PC**), grab your dice, a blank character sheet, and go through the next few pages. You can also view a walkthrough at [youtube.com/thearcanelibrary.](https://www.youtube.com/watch?v=r4ZGQfv4k8k&t=1s)
...
Your AC starts at 10 + your Dexterity modifier. Wearing armor changes your AC (see Armor, [pg. 34](#page-33-0)).

#### **ATTACKS**

The weapons you wield and how you use them to fight an enemy (see Combat on [pg. 50](#page-49-1)  for details). You can wield the weapons listed for your class.
...
Some classes can learn and cast magic spells (see Casting Spells on [pg. 52](#page-51-1) for more details).
...
Most games begin with 1stlevel characters — fledgling heroes who are ready to go on dangerous adventures.

1st-level characters start with:

- Background, [pg. 14](#page-13-1)
- Stats, [pg. 15](#page-14-1)
- Choice of ancestry, [pg. 16](#page-15-1)
- Choice of class, [pg. 18](#page-17-1)-[24](#page-23-1)
- One class talent roll
- Hit points equal to one roll of their class's hit points die + their Constitution modifier (minimum 1)
- Title, [pg. 26](#page-25-1)
- Choice of alignment, [pg. 28](#page-27-1)
- 2d6 x 5 gold pieces to buy gear (see Gear, [pg. 32\)](#page-31-1).

{13}------------------------------------------------

# <span id="page-13-1"></span>Background

<span id="page-13-0"></span>Your background knowledge and skills might prove useful during your adventures.
...
| 20  | Chirurgeon.<br>You know anatomy, surgery, and first aid       |
|     |                                                               |
...
<span id="page-14-0"></span>To determine your character's stats, roll 3d6 in order for each one. Note each total and modifier on your character sheet.
...
You know the Common language and one additional common language [\(pg. 29\)](#page-28-1).

**Ambitious.** You gain one additional talent roll at 1st level.

{17}------------------------------------------------

# <span id="page-17-1"></span>Fighter Class

<span id="page-17-0"></span>Blood-soaked gladiators in dented armor, acrobatic duelists with darting swords, or far-eyed elven archers who carve their legends with steel and grit.
...
<span id="page-19-0"></span>Crusading templars, prophetic shamans, or mad-eyed zealots who wield the power of their gods to cleanse the unholy.
...
**Deity.** Choose a god to serve who matches your alignment (see Deities, [pg. 30](#page-29-1)). You have a holy symbol for your god (it takes up no gear slots).

**Spellcasting.** You can cast priest spells you know.

You know two tier 1 spells of your choice from the priest spell list on [pg. 57](#page-56-1).

Each time you gain a level, you choose new priest spells to learn according to the Priest Spells Known table.

For casting priest spells, see Spellcasting on [pg. 52.](#page-51-1)

#### **2d6 Effect** 2 Gain advantage on casting one spell you know 3-6 +1 to melee or ranged attacks 7-9 +1 to priest spellcasting checks 10-11 +2 to Strength or Wisdom stat **PRIEST TALENTS**
...
<span id="page-21-0"></span>Rooftop assassins, grinning con artists, or cloaked cat burglars who can pluck a gem from the claws of a sleeping demon and sell it for twice its worth.
...
# <span id="page-23-1"></span>Wizard Class

<span id="page-23-0"></span>Rune-tattooed adepts, bespectacled magi, and flameconjuring witches who dare to manipulate the fell forces of magic.
...
**Languages.** You know two additional common languages and two rare languages (see [pg.](#page-28-1)  [29\)](#page-28-1).
...
You know three tier 1 spells of your choice from the wizard spell list (see [pg. 57\)](#page-56-1).

Each time you gain a level, you choose new wizard spells to learn according to the Wizard Spells Known table.

For casting wizard spells, see Spellcasting on [pg. 52.](#page-51-1)
...
<span id="page-25-0"></span>As you gain levels, your title changes to reflect an increase in your fame (or infamy).
...
# <span id="page-27-1"></span>Alignment

<span id="page-27-0"></span>Alignment defines your role in the clash between good and evil. All creatures are connected to the eternal conflict waged by Law, Chaos, and Neutrality, whether they know it or not.
...
# <span id="page-28-1"></span>Languages
...
<span id="page-29-0"></span>The many gods of the universe are the personifications of Law, Chaos, and Neutrality.
...
#### <span id="page-29-1"></span>**SAINT TERRAGNIS (LAWFUL)**
...
<span id="page-31-0"></span>**Arrows.** Ammunition for shortbows or longbows.
...
<span id="page-31-1"></span>**Grappling hook.** A rope anchor with three curved tines.
...
|                 | CRAWLIN  |                   |            |
|-----------------|----------|-------------------|------------|
| Items           | Quantity | <b>Gear Slots</b> | Total Cost |
| Backpack        | 1        | 0                 | 2 gp       |
...
| Leather armor                 | 10 gp  | 1          | 11 + DEX<br>mod | -                           |
| Chainmail                     | 60 gp  | 2          | 13 + DEX<br>mod | Disadv on stealth, swim     |
| Plate mail                    | 130 gp | 3          | 15              | No swim,<br>disadv stealth  |
| Shield                        | 10 gp  | 1          | +2              | Occupies one hand           |
| Mithral (metal<br>armor only) | х4     | -1         | -               | No penalty<br>stealth, swim |
...
**Range.** You can use a weapon at close (C), near (N), or far (F) range (see Distances, [pg. 47\)](#page-46-0).

{35}------------------------------------------------

# <span id="page-35-0"></span>Character Names
...
| 20  | Grimm   | Ruhiel  | Grix   | Jasper          | Zoraan   | Godfrey |
 ...
 "Whoever named you sure got it right." -Ralina, halfling thief, to Rotbreath the Troll

{36}------------------------------------------------

# <span id="page-36-0"></span>Level Advancement
...
# <span id="page-38-0"></span>Gameplay

{39}------------------------------------------------

# <span id="page-39-0"></span>Rolling the Dice
...
When a d20 die roll shows a 20, what you're doing succeeds to your maximum capacity. An attack roll automatically hits and is a critical hit (see Damage on [pg. 51\)](#page-50-0).
...
<span id="page-40-0"></span>Sometimes the GM awards a **luck token** to a player for exceptional roleplaying, heroism, or just plain coolness.
...
<span id="page-41-0"></span>Certain tasks fall under specific stats. The following examples illustrate common uses for each one.
...
# <span id="page-42-0"></span>Making Checks
...
#### <span id="page-43-0"></span>**REAL TIME**
...
**Hours/Days Pass.** Effects with a duration shorter than the time passed expire. The GM uses overland travel rules to check for encounters (see *Game Master Quickstart Guide*, pg. 14).
...
#### <span id="page-44-0"></span>**INITIATIVE**
...
<span id="page-45-0"></span>Characters are in **crawling rounds** while not in combat.
...
While in total darkness, a creature who is not darknessadapted has disadvantage on most tasks it tries to undertake, as determined by the GM.

Also, the environment becomes **deadly**. Check for a random encounter every crawling round.

{46}------------------------------------------------

#### <span id="page-46-0"></span>**MOVEMENT**
...
**Swimming.** Swim at half speed (STR check in rough water). Hold breath for rounds equal to CON mod (min. 1). Then, CON check each round or 1d6 damage per round until you exit the hazard.
...
#### <span id="page-47-0"></span>**RESTING**

Injured or unconscious PCs can rest to recover from their wounds. To rest, a character must sleep for 8 hours and consume (or be fed) a ration.
...
#### <span id="page-47-1"></span>**DANGER LEVEL**
...
# <span id="page-48-0"></span>Stealth and Surprise
...
A creature who begins its turn undetected has the advantage of surprise. If combat hasn't started yet, those with surprise take one turn before the combat initiative roll (see Combat Initiative! on [pg. 50](#page-49-2)).
...
<span id="page-49-0"></span>When a fight breaks out, **combat rounds** begin!
...
#### <span id="page-49-2"></span>**COMBAT INITIATIVE!**
...
#### <span id="page-49-1"></span>**ACTIONS**
...
**Cast A Spell.** Casting a spell takes one action (see Spellcasting on [pg. 52\)](#page-51-1).
...
**Critical Hit.** You deal a critical hit if you roll a natural 20 on an attack roll or spellcasting check. For a **weapon**, double its damage dice on the attack. For a **spell**, you may double one of its numerical effects (see [pg. 53\)](#page-52-0).
...
**Stabilize.** An intelligent being can give first aid to a dying creature at close range. On a successful DC 15 INT check, the target stops dying but is still unconscious; see Resting, [pg. 48](#page-47-1).

**Death.** A character who perishes is retired from the game.

{51}------------------------------------------------

# <span id="page-51-1"></span>Casting Spells

<span id="page-51-0"></span>Spellcasters use the raw power of creation and destruction to bend reality, shaping it to the will of their gods or ambitions.
...
#### <span id="page-52-0"></span>**CRITICAL SUCCESS**

If you roll a natural 20 on your spellcasting check, you may double one of the spell's numerical effects. This remains in effect on a **focus** spell (see [pg. 56\)](#page-55-1) until your next focus check.

#### **CRITICAL FAILURE**

If you roll a natural 1 on your spellcasting check, the spell does not take effect. If it was a **focus** spell, the spell immediately ends (see [pg. 56](#page-55-1) for more details on focus spells).

**Wizard Spell.** If the spell was a wizard spell, you can't cast that spell again until you successfully complete a rest. You must also roll on the Wizard Mishap table corresponding to the spell's tier (see [pg. 54](#page-53-1)).
...
# <span id="page-53-1"></span><span id="page-53-0"></span>Wizard Mishaps

|     | WIZARD MISHAP TIER 1-2                                                                                                                                                                                |
|-----|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| d12 | Effect                                                                                                                                                                                                |
| 1   | Devastation! Roll twice and combine both effects (reroll<br>any further 1s)                                                                                                                           |
...
| 6   | Discorporation! One random piece of your gear<br>disappears forever                                                                                                                                   |
| 7   | Spell worm! You lose the ability to cast a random spell<br>on each of your turns until you pass a DC 12 Constitution<br>check. You regain the ability to cast those spells after<br>completing a rest |
| 8   | Harmonic failure! You lose the ability to cast a random<br>spell until you complete a rest                                                                                                            |
| 9   | Poof! You suppress all light within a near distance from<br>you, including sunlight and magical light, for 10 rounds                                                                                  |
| 10  | The horror! You scream uncontrollably for 3 rounds in<br>Primordial, drawing lots of attention                                                                                                        |
| 11  | Energy surge! You glow bright purple for 10 rounds,<br>granting enemies advantage on attacks against you                                                                                              |
| 12  | Unstable conduit! You have disadvantage on casting<br>spells of the same tier for 10 rounds                                                                                                           |

{54}------------------------------------------------

# <span id="page-54-0"></span>Scrolls and Wands
...
# <span id="page-55-0"></span>Spell Attributes
...
**Failure.** The spell ends. If you were focusing, you do not lose the ability to cast that spell. However, if you **critically fail** on a check to maintain focus, treat it as a standard critical failure (see [pg. 53](#page-52-0) for details on criticals).
...
# <span id="page-56-1"></span>Spell Lists

#### <span id="page-56-0"></span>**PRIEST TIER 1**

- [Cure Wounds](#page-59-0)
- [Holy Weapon](#page-61-0)
- [Light](#page-61-1)
- [Protection From Evil](#page-63-0)
- [Shield of Faith](#page-63-1)
- [Turn Undead](#page-64-0)

#### **PRIEST TIER 2**

- [Augury](#page-57-1)
- [Bless](#page-58-0)
- [Blind/Deafen](#page-58-1)
- [Cleansing Weapon](#page-59-1)
- [Smite](#page-64-1)
- [Zone of Truth](#page-64-2)

#### **WIZARD TIER 1**

- [Alarm](#page-57-2)
- [Burning Hands](#page-58-2)
- [Charm Person](#page-58-3)
- [Detect Magic](#page-59-2)
- [Feather Fall](#page-59-3)
- [Floating Disk](#page-60-0)
- [Hold Portal](#page-60-1)
- [Light](#page-61-1)
- [Mage Armor](#page-62-0)
- [Magic Missile](#page-62-1)
- [Protection From Evil](#page-63-0)
- [Sleep](#page-63-2)

#### **WIZARD TIER 2**

- [Acid Arrow](#page-57-3)
- [Alter Self](#page-57-4)
- [Detect Thoughts](#page-59-4)
- [Fixed Object](#page-60-2)
- [Hold Person](#page-60-3)
- [Invisibility](#page-61-2)
- [Knock](#page-61-3)
- [Levitate](#page-61-4)
- [Mirror Image](#page-62-2)
- [Misty Step](#page-62-3)
- [Silence](#page-63-3)
- [Web](#page-64-3)
...
#### <span id="page-57-3"></span><span id="page-57-0"></span>**ACID ARROW**
...
#### <span id="page-57-4"></span>**ALTER SELF**
...
#### <span id="page-58-1"></span>**BLIND/DEAFEN**
...
#### <span id="page-58-2"></span>**BURNING HANDS**
...
#### <span id="page-58-3"></span>**CHARM PERSON**
...
#### <span id="page-59-1"></span>**CLEANSING WEAPON**
...
#### <span id="page-59-0"></span>**CURE WOUNDS**
...
#### <span id="page-59-2"></span>**DETECT MAGIC**
...
#### <span id="page-59-4"></span>**DETECT THOUGHTS**
...
#### <span id="page-59-3"></span>**FEATHER FALL**
...
#### <span id="page-60-2"></span>**FIXED OBJECT**
...
#### <span id="page-60-0"></span>**FLOATING DISK**
...
#### <span id="page-60-3"></span>**HOLD PERSON**
...
#### <span id="page-60-1"></span>**HOLD PORTAL**
...
#### <span id="page-61-0"></span>**HOLY WEAPON**
...
#### <span id="page-61-2"></span>**INVISIBILITY**
...
#### <span id="page-61-4"></span>**LEVITATE**
...
#### <span id="page-62-0"></span>**MAGE ARMOR**
...
#### <span id="page-62-1"></span>**MAGIC MISSILE**
...
#### <span id="page-62-2"></span>**MIRROR IMAGE**
...
## <span id="page-62-3"></span>**MISTY STEP**
...
### <span id="page-63-0"></span>**PROTECTION FROM EVIL**
...
When cast on an alreadypossessed target, the possessing entity makes a CHA check vs. the last spellcasting check. On a failure, the entity is expelled.

#### <span id="page-63-1"></span>**SHIELD OF FAITH**
...
#### <span id="page-63-3"></span>**SILENCE**
...
#### <span id="page-64-0"></span>**TURN UNDEAD**
...
#### <span id="page-64-2"></span>**ZONE OF TRUTH**
...
**Discord link:** [https://discord.gg/](https://discord.gg/thearcanelibrary) thearcanelibrary
...
**Newsletter link:** [https://www.](https://www.thearcanelibrary.com/pages/shadowdark-rpg-newsletter) [thearcanelibrary.com/pages/](https://www.thearcanelibrary.com/pages/shadowdark-rpg-newsletter) [shadowdark-rpg-newsletter](https://www.thearcanelibrary.com/pages/shadowdark-rpg-newsletter)

#### **FIND ADVENTURES AND CONTENT**

Visit **[thearcanelibrary.com](https://www.thearcanelibrary.com)** for the latest in *Shadowdark RPG* adventures and articles.
...
Follow The Arcane Library on **[youtube.com/thearcanelibrary](https://www.youtube.com/thearcanelibrary)**  for video guides, tips, tricks, and adventure walkthroughs!

Finally, spectacular **creators**  such as [Taylor Seely-Wright](https://www.drivethrurpg.com/browse/pub/16706/Taylor-SeelyWright?term=Taylor+seel), [Laurin-David Weggen,](https://www.drivethrurpg.com/browse.php?keywords=Laurin-David+Weggen&x=0&y=0&author=&artist=&pfrom=&pto=) James Mishler, and [Jake Savala](https://brewin-druid.itch.io)  [\(brewin\\_druid\)](https://brewin-druid.itch.io) have published an amazing array of adventures, settings, character options and more under the Shadowdark RPG Third-Party License.
