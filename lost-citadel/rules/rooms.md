# The Lost Citadel — Room Key (Areas 1-27)
...
## Area 2: BLINDING CAVE (20' × 30', ceiling ~15')

**Player Description:**
Your torch hits the walls and *explodes* into a thousand points of light. The stone is flecked with smooth quartz shards that refract and scatter your flame. A dizzying kaleidoscope.

**GM Notes:**
- Walls are dazzlingly reflective. **DC 12 DEX check** when entering with bright light or blinded for 1d4 rounds. Ettercaps unaffected.
  - ▶ Careful extraction yields a quartz mirror piece.
- White Bundles: Five beastmen wrapped in ettercap silk. **1:6 chance** one is still alive.
  - ▶ Pearl (40 gp) hidden in one creature's mouth (Eska's stolen prize from Area 4).
- Ettercap Ambush (if Eska raised alarm): Three hostile ettercaps cling to ceiling.

**Connections:**
- West → Area 1 (Mural Chamber) — via L-shaped hallway with stairs descending
- East → Area 3 (Web-Choked Cave)
- North → Area 5 (Robing Chamber)

---

## Area 3: WEB-CHOKED CAVE (circular, ~40' diameter, ceiling 15')

**Player Description:**
A large, roughly circular chamber. Thick, gauzy webbing covers the walls and floor, sticky and dust-laden. The air smells sour—insect musk and decay.

**GM Notes:**
- Webs are sticky. **DC 12 STR check** each turn to break free. Highly flammable: **1d6 damage** to stuck creatures, burns for 1d4 rounds.
  - ▶ Rolled parchment (10' up in webs): *Scroll of Hold Portal*
- Secret Tunnel hidden by webs. Ettercaps reseal it each time they pass.
  - ▶ From inside: hear shrill, tittering whispers from Area 4.

**Connections:**
- West → Area 2 (Blinding Cave) — rough tunnel
- South → Area 4 (Ettercap Nest) — secret door
...
## Area 5: ROBING CHAMBER (20' × 20')

**Player Description:**
A small antechamber. A skeleton pinned to one wall by a spear driven through its ribcage. Chipped mosaics show acrobats leaping bulls. Four white robes hang from wooden pegs, musty and rotting.

**GM Notes:**
- Skeleton: Decaying crimson leather armor. Bronze shortsword on belt.
  - ▶ Spear: Driven deep with inhuman force. Bronze tip (artifact damage).
- Robes: Four musty, rotten. **Bronze key to Area 21** in one pocket.
...
## Area 6: BATHHOUSE (25' × 40')

**Player Description:**
A sunken bathhouse. Six large stone basins carved with serpent motifs line the walls. In the center stands a life-sized statue—a woman with writhing snake hair, arms raised, mouth open in a scream.

**GM Notes:**
- Statue: Hinged arms. Turning them down causes **scalding water to spew from mouth**. **DC 12 DEX or 1d4 damage**.
...
**GM Notes:**
- Statue: Motion-activated. **3:6 chance/round** it animates and charges down hall (ignores Scarlet Minotaur). **DC 15 DEX or 2d6 damage + knocked flat**. Resets.
...
## Area 8: BLOOD BOWLS (25' × 25', with 3 alcoves on north and south walls)

**Player Description:**
A small chamber with dark stone alcoves. Each alcove holds a terracotta bowl on a black plinth. The walls are carved with a repeating seal showing a warrior kneeling beneath black rain, arms open to sky.

**GM Notes:**
- Bowls: Filling with **fresh blood charges it with healing magic** (1d4 HP restored, must drink). Bowl crumbles after use.
...
## Area 9: SORCEROUS PILLARS (20' × 60')

**Player Description:**
A long, narrow hall dominated by four pairs of jewel-toned pillars with black marble caps. The floor is littered with salt residue and scorched earth. A purple, spindly humanoid corpse lies facedown in the center, fur matted and blackened. Beyond, an altar holds a bronze greatsword.

**GM Notes:**
- Pillars activate in sequence (north to south). Returning past ends effect:
  - ▶ **Red Pillars:** Flammable items ignite. 1d4 damage/round.
  - ▶ **Blue Pillars:** Sea water fills lungs. Drown in 1d6 rounds.
  - ▶ **Green Pillars:** Poisoned. DC 12 CON or lose turn.
  - ▶ **Purple Pillars:** Blinded, move half speed.
- Ettercap Body: Scorched fur, salt rime on mouth & chest, claw marks around eyes.
- Greatsword: **DC 12 STR to pull from altar**. **+1 Greatsword "Asterion"** — wielder cannot be moved against their will.

**Connections:**
- South → Area 8 (Blood Bowls)
- North → Hallway west toward Area 10
...
## Area 14: HIDDEN HALL (20' × 40')

**Player Description:**
A narrow, silent hall. The air is stale and foul—urine, body odor, something unwashed. The floor is scattered with rat bones and the dried husk of a massive centipede.

**GM Notes:**
- Beastmen: Three. Grey fur. Stand by doors listening. Regroup here if PCs enter. Adjust attitude toward **hostile** if PCs are noisy.
  - ▶ **NPCs:** Haruut (stocky, mistrustful), Grall (young, timid), Chops (long jowls, blustery). Whisper; cringe at loud sounds.
...
- Bull Statue Horns: 30 humanoid skulls, various rot states. Some grey fur.
  - ▶ **Ritual Sacrifice:** Punching fresh beheaded skull onto horn grants +1 STR. Each additional time: **cumulative 1:4 chance** of transforming into beastman.
- Bones: Trampled, no skulls. Piles of dented armor, broken weapons (steel & bronze).
  - ▶ **Treasure (each round sifting):**
    1. Scarred mithral shield (prowling tiger carving) — 40 gp
...
## Citadel Exteriors (Entrances)

- **Southeast Doors** → Area 1 (carved bucking bulls)
- **Northeast Hall** → Area 10 (shattered door, stairwell)
- **Southwest Tunnel** → Area 22 (open, leads into labyrinth)
- **Courtyard** → Area 18 (open-air, rooftop climbers can reach)
